package net.evm.abi.decoder;

import net.evm.abi.decoder.DecodedFunctionCall;
import net.evm.abi.definition.AbiDefinition;
...
public class AbiDecoder {
    ...
    public AbiDecoder(String abiFilePath) throws IOException {
        String content = new String(Files.readAllBytes(Paths.get(abiFilePath)));
        this.abi = AbiDefinition.fromJson(content);
        init();
    }
