...
import lombok.Data;
import net.evm.abi.definition.SolidityType;
import net.evm.abi.util.ByteUtil;
import net.evm.abi.util.HashUtil;
...
import static net.evm.abi.definition.SolidityType.IntType.decodeInt;
import static org.apache.commons.collections4.ListUtils.select;
import static org.apache.commons.lang3.ArrayUtils.subarray;
import static org.apache.commons.lang3.StringUtils.join;
import static org.apache.commons.lang3.StringUtils.stripEnd;

public class AbiDefinition extends ArrayList<net.evm.abi.definition.AbiDefinition.Entry> {
    ...
    public static net.evm.abi.definition.AbiDefinition fromJson(String json) {
        try {
            return DEFAULT_MAPPER.readValue(json, net.evm.abi.definition.AbiDefinition.class);
        } catch (IOException e) {
            throw new RuntimeException(e);
        }
    }

    public static net.evm.abi.definition.AbiDefinition fromJson(Reader reader) {
        try {
            return DEFAULT_MAPPER.readValue(reader, net.evm.abi.definition.AbiDefinition.class);
        } catch (IOException e) {
            throw new RuntimeException(e);
        }
    }

    public static net.evm.abi.definition.AbiDefinition fromJson(InputStream inputStream) {
        try {
            return DEFAULT_MAPPER.readValue(inputStream, net.evm.abi.definition.AbiDefinition.class);
        } catch (IOException e) {
            throw new RuntimeException(e);
        }
    }
