...
public class EthereumManager {
    ...
    public static String createWallet(String filePath) throws CipherException, IOException {
        createOrExistsDir(new File(filePath));
    ...
    public static String getEthAddress(String mnemonic, int id) {
        ...
        System.out.println("私钥： "+ deterministicKey.getPrivKey());
     ...
     * 通过private key生成credentials
     */
    public static Credentials GenerateCredentials(ECKeyPair ecKeyPair) {
